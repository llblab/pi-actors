...
- `[Scripts]` Migrated `recipe-utils`, `build-dist`, and `locker` command logic behind compiled TypeScript modules while preserving the stable `scripts/*.mjs` shim paths.
