...
export function assertRecipeHasNoMailbox(recipe) {
    if (Object.hasOwn(recipe, "mailbox")) {
        throw new Error("recipe.mailbox was removed; replace it with control: [\"action\"] for actor-local inputs and emit Trace events for outputs");
    }
}
