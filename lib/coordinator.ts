/**
 * Multi-actor coordinator helper entrypoint logic.
 * Zones: swarm coordination, worker pool orchestration
 */
...
export async function runCoordinator(argv = process.argv.slice(2)) {
currentArgv = argv;
const config = {
  runId: arg(
    "run-id",
